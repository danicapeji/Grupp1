...
const LandingPage = () => {
  ...
  // Function to find the first product image for each category
  const getCategoryImages = () => {
    ...
    categories.forEach((category) => {
      ...
      if (productInCategory) {
        categoryImages[category] = productInCategory.image;
      } else {
        categoryImages[category] = "default_image_url.jpg"; // Default image if no product found
      }
    });
