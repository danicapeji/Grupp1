...
const LandingPage = () => {
  ...
  return (
    <><div className="header w-full p-4 mt-20">
    ...
    </div><h2 className="text-2xl font-semibold text-center">Välkommen!</h2><p className="text-lg text-gray-700 mb-4 text-center">
      ...
      </div><h2 className="text-2xl font-semibold text-center">Kategorier</h2><div>
      ...
      </div><h2 className="text-2xl font-semibold text-center">Start here!</h2><p className="text-lg text-gray-700 mb-4 text-center">
        Explore our latest collection and experience a world of style and comfort!
      </p><div className="grid grid-cols-2 lg:grid-cols-4 gap-1 md:gap-4 mt-8">
        {products.slice(0, 4).map((product) => (
          <ProductCard key={product.id} product={product} />
        ))}
      </div></>
